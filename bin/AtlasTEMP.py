...
def output(writeHere:str="STDOUT", measurement:str="NONE", unit:str="f", showdeviceinfo:bool=False, deviceinfo:str="NONE"):
...
def main():
	...
	if (args.listentime==-1):
		...
		while True:
			...
			output(args.output, measurement, args.unit.upper(), args.show_device_info, device_info)
